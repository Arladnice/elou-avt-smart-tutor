...
1. **Модель базовых понятий BACCM™ (Business Analysis Core Concept Model):**
   Бизнес-анализ в Smart Tutor строится на 6 взаимосвязанных концептах:
...
## 📐 6 Областей знаний BABOK v3 в Smart Tutor
...
4. **Анализ стратегии (Strategy Analysis):** Оценка текущего состояния (*As-Is*: импортные КТ Honeywell/Yokogawa) и будущего (*To-Be*: отечественный Smart Tutor на Python/React), GAP-анализ.
...
* **10.4 Бенчмаркинг и анализ рынка:** Сравнение с зарубежными аналогами в [`docs/market_analysis.md`](file:///e:/Git-Projects/elou-avt-smart-tutor/docs/market_analysis.md).
* **10.7 Бизнес-кейсы & 10.20 Финансовый анализ:** Расчёт NPV, PI, DPP и TCO в [`docs/economics.md`](file:///e:/Git-Projects/elou-avt-smart-tutor/docs/economics.md).
...
* **10.46 SWOT-анализ:** Оценка сильных и слабых сторон в [`docs/Сводная_пояснительная_записка.md`](file:///e:/Git-Projects/elou-avt-smart-tutor/docs/Сводная_пояснительная_записка.md).
