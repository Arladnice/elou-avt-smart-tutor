/**
 * Технологические пороги установки. Значения согласованы с config.py бэкенда —
 * при изменении там правим здесь же, иначе подсказки ИИ и графики разойдутся
 * с реальными срабатываниями защит.
 */
