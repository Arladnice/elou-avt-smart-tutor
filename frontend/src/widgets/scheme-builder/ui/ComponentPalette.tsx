    ...
    items: [
      {
        ...
        defaultData: { kind: 'crude', length: 140, orientation: 'horizontal' },
      },
      {
        type: 'pipe',
        name: 'Линия сброса газа',
        sub: 'Сброс на факельную установку',
        defaultData: { kind: 'gas', length: 140, orientation: 'horizontal' },
      },
      {
        type: 'pipe',
        name: 'Паропровод',
        sub: 'Подача водяного пара',
        defaultData: { kind: 'steam', length: 120, orientation: 'horizontal' },
      },
      {
        type: 'pipe',
        name: 'Дренажная линия',
        sub: 'Дренаж в емкость или закрытую сеть',
        defaultData: { kind: 'drain', length: 100, orientation: 'vertical' },
      },
      {
        type: 'label',
