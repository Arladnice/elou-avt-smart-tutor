    ...
    items: [
      {
        ...
        defaultData: { kind: 'crude', d: 'M 100,200 H 260' },
      },
      {
        type: 'pipe',
        name: 'Линия сброса газа',
        sub: 'Сброс на факельную установку',
        defaultData: { kind: 'gas', d: 'M 100,100 H 260' },
      },
      {
        type: 'pipe',
        name: 'Паропровод',
        sub: 'Подача водяного пара',
        defaultData: { kind: 'steam', x1: 100, y1: 100, x2: 240, y2: 100 },
      },
      {
        type: 'pipe',
        name: 'Дренажная линия',
        sub: 'Дренаж в емкость или закрытую сеть',
        defaultData: { kind: 'drain', x1: 100, y1: 100, x2: 100, y2: 180 },
      },
      {
        type: 'label',
