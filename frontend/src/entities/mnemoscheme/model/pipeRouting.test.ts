...
describe('getSnapPorts and findMatchingPort', () => {
  const dummyScheme: MnemoschemeConfig = {
    ...
    height: 600,
    zones: [],
    columns: [{ id: 'col-1', tag: 'К-1', equipmentId: 'K_1', levelBinding: 'L_1', x: 400, y: 100, alertBindings: [] }],
    furnaces: [{ id: 'fur-1', tag: 'П-1', equipmentId: 'P_1', flameBinding: 'Flame_P1', x: 600, y: 200, alertBindings: [] }],
    vessels: [{ id: 'ves-1', tag: 'Е-1', equipmentId: 'VESSEL_E_1', x: 200, y: 300, alertBindings: [] }],
