...
if len(os.environ.get("INTEGRITY_SALT", "")) < 32:
    os.environ["INTEGRITY_SALT"] = "test_integrity_salt_2026_default_32"

if len(os.environ.get("SECRET_KEY", "")) < 32:
    os.environ["SECRET_KEY"] = "test_jwt_secret_key_2026_default_32"
