...
_DEFECTS = {
    "pump_fail": "Отказ сырьевого насоса Н-20: снизьте уставки П-1 и П-3, остановите Н-20, затем закройте V-1.",
    ...
    "vt_vacuum_loss": "Срыв вакуума ВТ: снизьте уставки П-1 и П-3 до 200°C, остановите Н-20 и закройте V-1. Затем закройте пар К-2; пар К-1 не отключайте, газовый сброс К-2 не открывайте. Включите горячую циркуляцию и оставьте Н-2, Н-3 и один насос К-2 в работе.",
    "k2_pump_fail": "Отказ Н-4/Н-32: закройте V-3, остановите Н-20 и закройте V-1, чтобы прекратить поступление продукта в К-2; затем выполните перевод на рециркуляцию.",
}

_DEFECT_ALIASES = {
    "pump_fail": ("отказ насоса", "н-20", "н20", "сырьев", "pump_fail"),
