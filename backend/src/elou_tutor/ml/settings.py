...
# Веса вакуумного блока К-2. Заданы по аналогии с соответствующими контурами
# К-1, потому что последствия в HAZOP-диаграмме сопоставимы: срыв вакуума —
# коксование и крекинг мазута (как рост давления К-1), перегрев куба — то же
# коксование (как перегрев печи), захлёбывание — переброс продукта.
# Сеть эти параметры не прогнозирует: вклад К-2 считается по факту.
RISK_WEIGHT_K2_PRESSURE = 55.0
RISK_WEIGHT_K2_TEMP = 45.0
RISK_WEIGHT_K2_LEVEL = 20.0
