...
K2_PRESSURE_WARNING = 0.07               # МПа, начало расчётного опасного интервала
K2_PRESSURE_CRITICAL = 0.147             # МПа, 1,5 кгс/см²
...
K2_LEVEL_LOW = 18.0                      # %, предупреждение по низкому уровню
K2_LEVEL_LOW_INTERLOCK = 12.0            # %, блокировка насосов Н-4/Н-32
K2_LEVEL_LOW_CRITICAL = 8.0              # %, критическая ступень сигнализации
