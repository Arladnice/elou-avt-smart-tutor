...
# FRC 458/459/460. Защита насосов куба оставлена как учебная, но порог взят
# единый по установке — 15%, как у Е-1, Е-2, К-2 и стриппингов.
COLUMN_LEVEL_LOW_INTERLOCK = 15.0 # % (учебная блокировка насосов куба К-1)
