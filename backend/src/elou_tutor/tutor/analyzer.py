    ...
    def _evaluate_defect_handling(self, actions, defects_triggered,
        ...
        if "pump_fail" in defects_triggered:
            ...
            return 30, [TECH_REGULATIONS["P1_DRY_HEAT"]], [
                "При отказе Н-20 сначала снизьте уставки П-1 и П-3, затем убедитесь, что "
                "насос остановлен, и только после этого закройте V-1, чтобы исключить "
                "сухой перегрев змеевиков.",
